...
const profileStages: ProfileStage[] = [
  ...
  },
  {
    ...
    command: '阿里巴巴与蚂蚁集团',
    title: '阿里巴巴与蚂蚁集团',
    subtitle: '2022.04-2026.01 第一次的社会化过程，逐渐形成从场景理解到体验落地的工作方式。',
    cards: [
      {
        title: '特色客群金融产品设计',
      ...
      {
        title: '支付结算与平台型产品设计',
        body: '负责转账/入金/还款等银行场景的核心链路体验优化，并基于平台视角定义银行App的消息与待办/安全界限/快捷支付等设计规范。\n\n 在成熟的标准化链路里探索创新机会，加强了一致性的框架设计和推动能力。',
      },
      {
        title: '用户洞察与研究',
        body: '主导信贷侧相关用研，参与更前置的人群识别、机会判断和产品方向定义，如多主体授信方案/农村客群理财与贷款心智等项目。\n\n 摸索出更加“在地性”的调研方法和手段，强化跨职能的协作能力。',
      },
    ],
  },
  {
    id: 'fintech',
    command: '金融科技研究院',
    title: '金融科技研究院-数字化运营部',
    subtitle: '2026.01-至今 接住这个机会是以为能有更大的scope，参与更广泛的设计形态。很可惜遇到了一些现实的遏制。',
    cards: [
      {
        title: '服务设计',
        body: '参与战略级项目，加强线上线下服务体验的一致性，对金融服务中的体验设计有了更强的感悟。',
      },
      {
        title: '下一代 AI 产品探索',
        body: '探索下一代 AI 产品架构，定义设计规范。\n\n 通过混合调研方式为AI产品方向定基础，包括实际用户调研和通过搭建SKILL完成的社媒用户评价分析。根据调研结果vibe未来AI产品原型，沉淀设计规范的design.md文档，拉齐团队从"设计意图→可运行原型"的快速验证链路。',
      },
      {
        title: 'AI 学习组织',
        body: '组织部门定期开展AI分享会，学习AI知识与工作应用案例。探索多样汇报形式与工具，制作科室网站展示重点工作成果。',
      },
    ],
  },
];
